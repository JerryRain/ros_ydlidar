#ifndef _ROS_msgs_demo_PoseWithCovariance_h
#define _ROS_msgs_demo_PoseWithCovariance_h
...
namespace msgs_demo
{
  ...
  {
    public:
      typedef msgs_demo::Pose _pose_type;
      _pose_type pose;
      float covariance[36];
    ...
    const char * getType(){ return "msgs_demo/PoseWithCovariance"; };
