...
namespace mbf_msgs
{
  ...
  class MoveBaseResult : public ros::Msg
  {
    public:
      ...
      enum { FAILURE =  10 };
      enum { CANCELED =  11 };
      enum { PAT_EXCEEDED =  12 };
      enum { COLLISION =  13 };
      enum { OSCILLATION =  14 };
      enum { ROBOT_STUCK =  15 };
      enum { START_BLOCKED =  16 };
      enum { GOAL_BLOCKED =  17 };
      enum { TF_ERROR =  18 };
      enum { INVALID_PLUGIN =  19 };
      enum { INTERNAL_ERROR =  20 };
    ...
    const char * getMD5(){ return "88a3b817098a081f3982a20a1b915e4c"; };
